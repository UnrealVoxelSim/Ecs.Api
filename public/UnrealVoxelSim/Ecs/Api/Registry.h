...
concept Registry = requires(TRegistry &registry, const TRegistry &constRegistry, EntityId entity,
...
concept ComponentRegistry = Registry<TRegistry> && requires(TRegistry &registry, const TRegistry &constRegistry,
                                                            EntityId entity, TComponent component) {
